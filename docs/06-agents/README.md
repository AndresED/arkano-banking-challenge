# Agentes e implementación (`docs/06-agents`)

Especificaciones pensadas para **agentes de código** o desarrolladores que generan o amplían el proyecto a partir de una descripción fija.
